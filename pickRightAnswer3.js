...
alert("Ấn OK để chọn "+pickCount+"/"+cauHoi.length+" câu, các câu đúng sẽ chuyển thành màu đỏ, bạn có thể chọn lại để điểm thấp hơn (mỗi câu "+10/cauHoi.length+" điểm).");
